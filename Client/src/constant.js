...
export const base_url = "https://www.justaskhim.org:3000";
...
export const homeInformation = [
  {
    ...
    btnText: "Just ask him",
    imgInfo: info1,
  },
  {
    title: "What does it mean to be a Christian?",
    peragraph:
      "You have heard about the Bible, you’ve heard about Jesus, and you want to know what it means to be a Christian. Just ask him. His AI responses are crafted from his speech and character in the Bible. He is here to support you.",
    askQue: "Have any question?",
    btnText: "Just ask him",
    imgInfo: info2,
  },
...
export const askingData = [
  {
    title: "What would Jesus do?",
    subTitle:
      "Are you wrestling with a tough decision?  Do you have a difficult choice to make? Do you want to know what Jesus would do? Just ask him",
    btnText: "Ask Now",
  },
  {
    title: "Is the Bible True?",
    subTitle:
      "How do I know if the Bible is true? How do I know it’s God’s word? How can I trust the Bible? Just ask him",
    btnText: "Ask Now",
  },
  {
    title: "Questions For God",
    subTitle:
      "If God is a God of love, why do bad things happen to good people? Why is there evil in the world? How do I know you are real? Just ask him",
    btnText: "Ask Now",
  },
  {
    title: "",
