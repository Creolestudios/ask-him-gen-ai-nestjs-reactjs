      ...
      <Container>
        <div className="about-wrapper">
          <div className="single-column">
            ...
            <p className="extra-large-body">
              The Just Ask Him team leverages AI technology, seminary trained
            ...
            <p className="extra-large-body">
              ...
              face. And now you can through Just Ask Him.
            </p>
          </div>
          <div className="two-column">
            <div className="left">
              ...
              <p className="extra-large-body">
                Your questions and conversations are anonymous. The Just Ask Him
